  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0E0E0F', fontFamily: 'sans-serif', overflowX: 'hidden', maxWidth: '100vw', width: '100%' }}>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 640px) {
          ...
          .players-pad { padding-bottom: 88px !important; }
        }
      ...
      {/* ═══════════════════════════════════════
          PLAYER CARDS LAYOUT
      ═══════════════════════════════════════ */}
      <div className="players-pad" style={{ display: 'flex', flexDirection: 'column', maxWidth: '720px', margin: '0 auto', width: '100%' }}>
        ...
        {/* KPI cards */}
        <div className="kpi-grid" style={{ padding: '0 16px 16px', display: 'grid', gap: '10px' }}>
          {[
      ...
      <div className="mobile-bottom-nav-clients" style={{ position: 'fixed', bottom: 0, left: 0, right: 0, height: '72px', background: '#0E0E0F', borderTop: '1px solid #2A2A2D', zIndex: 200, alignItems: 'stretch' }}>
        {([
          ...
          { label: 'Groups', path: '/dashboard/groups', active: false, icon: (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
